...
namespace ABCommunication
{
    ...
    //{
    //    public static string WorkOrder { get; set; } = "Not Init.";
    //    public static string WorkOrder_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.FromCogent.WorkOrder_Adrs}";
    ...
    //    public static string Heartbeat_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.FromCogent.Heartbeat_Adrs}";
    ...
    //    public static string ActualCoreLoss_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.ToCogent.ActualCoreLoss_Adrs}";
    //    public static double ActualAmpTurns { get; set; } = -99;
    //    public static string ActualAmpTurns_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.ToCogent.ActualAmpTurns_Adrs}";
    //    public static Int32 ServerResult { get; set; } = -99;
    //    public static string ServerResult_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.ToCogent.ServerResult_Adrs}";
    //    public static bool HeartbeatEcho { get; set; } = false;
    //    public static string HeartbeatEcho_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.ToCogent.HeartbeatEcho_Adrs}";
    //    public static bool InAuto { get; set; } = false;
    //    public static string InAuto_Address { get; set; } = "{Ch_AT_1_Ch}{Adrs_PROGRAM:Tester.BrockhouseInterface.ToCogent.InAuto_Adrs}";
    //}
    ...
    //    {
    //        bool Success = true;
    //        if (Success) FromPLC.WorkOrder = PLC.CommManager.GetPLCValue_STRING(FromPLC.WorkOrder_Address, out Success);
    ...
    //        ToPLC.HeartbeatEcho = !ToPLC.HeartbeatEcho;
    //        if (Success) Success = PLC.CommManager.SetPLCValue(ToPLC.HeartbeatEcho_Address, !ToPLC.HeartbeatEcho);
